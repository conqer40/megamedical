/* ==========================================================================
   Mega Medical - Dedicated Products Catalogue Controller
    ...
    <div class="modal-product-layout">
      ...
      <div class="modal-details-col">
        ...
        <div class="modal-actions-toolbar">
          ...
          <a href="https://wa.me/201025930930?text=${encodeURIComponent('Hello Mega Medical Export Desk, I would like to request an official proforma quotation and technical spec sheet for ' + item.code + ' (' + item.name + ').')}" target="_blank" class="btn-modal-whatsapp">
